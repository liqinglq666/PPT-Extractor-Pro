...
## ⚖️ 版权与开源协议 (Copyright & License)

* **版权所有 (Copyright)**：© 2026 李庆 (Li Qing). 保留所有权利。
* **开源协议**：本项目基于 **[MIT License](LICENSE)** 协议开源。
* **免责声明**：本项目仅供学术交流与办公效率提升使用，作者不对使用过程中可能产生的任何直接或间接损失负责。
* **禁止商业行为**：未经作者本人书面授权，禁止将本项目及其打包产物（EXE）用于任何商业售卖或盈利活动。
---
